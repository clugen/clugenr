...
```{r}
set.seed(seed)
e31 <- clugen(2, 5, 1500, c(1, 0), pi / 4, c(20, 20), 14, 2, 2.0, point_dist_fn = "n")
...
```{r}
set.seed(seed)
e32 <- clugen(2, 5, 1500, c(1, 0), pi / 4, c(20, 20), 14, 2, 2.0, point_dist_fn = "n", proj_dist_fn = "unif")
...
set.seed(seed)
e33 <- clugen(2, 5, 1500, c(1, 0), pi / 4, c(20, 20), 14, 2, 2.0, point_dist_fn = "n", proj_dist_fn = proj_beta)
