...
e094 = list(points = matrix(120 * runif(2 * 500) - 60, ncol = 2),
            clusters = factor(rep(10L, 500)))    # Assign noise to cluster 10
...
e097 <- clugen(2, 3, 50, c(-0.2, 1), 0., c(0, 0), 45, 5, 1,
               proj_dist_fn = "unif", clusizes_fn = c(20, 6, 25),
               clucenters_fn = matrix(c(-55, -5, 0, -20, 40, 0), byrow = TRUE, ncol = 2))
