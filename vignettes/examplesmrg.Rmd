...
e095 = clumerge(e094, e092, clusters_field = NA) # and keep 10 when merging
```
...
e100 <- append(e097, list(hclusters = factor(rep(2L, dim(e097$clusters)[1]))))
