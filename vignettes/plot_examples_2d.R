...
color_scales = list(
  seaborn = c("1" = "#1F77B4", "2" = "#FF7F0E", "3" = "#2CA02C", "4" = "#D62728",
              ...
              "9" = "#BCBD22", "10" = "#17BECF"),
  set2 = c("1" = "#66C2A5", "2" = "#FC8D62", "3" = "#8DA0CB", "4" = "#E78AC3",
           "5" = "#A6D854", "6" = "#FFD92F", "7" = "#E5C494", "8" = "#B3B3B3",
           "9" = "#A1C9F4", "10" = "#4FB031"),
  pastel = c("1" = "#A1C9F4", "2" = "#FFB482", "3" = "#8DE5A1", "4" = "#FF9F9B",
             "5" = "#D0BBFF", "6" = "#DEBB9B", "7" = "#FAB0E4", "8" = "#CFCFCF",
             "9" = "#FFFEA3", "10" = "#B9F2F0"),
  husl9 = c("1" = "#F67088", "2" = "#D58C31", "3" = "#A39F31", "4" = "#4FB031",
            "5" = "#34AE90", "6" = "#36AAB5", "7" = "#3BA3EC", "8" = "#BA82F4",
            "9" = "#F563D3", "10" = "#FF7F0E"))
