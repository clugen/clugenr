...
```{r}
e046 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 0, 0, 0.5,
              seed = seed, point_dist_fn = "n")
e047 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 10, 0, 0.5,
              seed = seed, point_dist_fn = "n")
e048 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 30, 0, 0.5,
              seed = seed, point_dist_fn = "n")
```

```{r}
plot_examples_3d(list(e = e046, t = "e046: llength = 0"),
                 list(e = e047, t = "e047: llength = 10"),
                 list(e = e048, t = "e048: llength = 30"))
```
...
```{r}
e049 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 15,  0.0, 0.5,
              seed = seed, point_dist_fn = "n")
e050 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 15, 10.0, 0.5,
              seed = seed, point_dist_fn = "n")
e051 <- clugen(3, 5, 800, c(1, 0, 0), pi / 10, c(10, 10, 10), 10,  0.1, 0.5,
              seed = seed, point_dist_fn = "n", llengths_fn = llen_grow)
```

```{r}
plot_examples_3d(list(e = e049, t = "e049: llength_disp = 0.0"),
                 list(e = e050, t = "e050: llength_disp = 10.0"),
                 list(e = e051, t = "e051: custom llengths function"))
```
...
```{r}
e052 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(30, 10, 10), 25, 4, 3, seed = seed)
e053 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(10, 30, 10), 25, 4, 3, seed = seed)
e054 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(10, 10, 30), 25, 4, 3, seed = seed)
```

```{r}
plot_examples_3d(list(e = e052, t = "e052: cluster_sep = [30, 10, 10]"),
                 list(e = e053, t = "e053: cluster_sep = [10, 30, 10]"),
                 list(e = e054, t = "e054: cluster_sep = [10, 10, 30]"))
```
...
```{r}
e055 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed)
e056 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed,
              cluster_offset = c(20, -20, 20))
e057 <- clugen(3, 8, 1000, c(1, 1, 1), pi / 4, c(10, 10, 10), 12, 3, 2.5, seed = seed,
              cluster_offset = c(-50, -50, -50), clucenters_fn = centers_diag)
```

```{r}
plot_examples_3d(list(e = e055, t = "e055: default"),
                 list(e = e056, t = "e056: cluster_offset = [20, -20, 20]"),
                 list(e = e057, t = "e057: custom clucenters function"))
```
