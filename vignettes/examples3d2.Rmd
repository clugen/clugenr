...
```{r}
e058 <- clugen(3, 4, 1000, c(1, 0, 0), pi / 2, c(20, 20, 20), 13, 2, 0.0, seed = seed)
e059 <- clugen(3, 4, 1000, c(1, 0, 0), pi / 2, c(20, 20, 20), 13, 2, 1.0, seed = seed)
e060 <- clugen(3, 4, 1000, c(1, 0, 0), pi / 2, c(20, 20, 20), 13, 2, 3.0, seed = seed)
```

```{r}
plot_examples_3d(list(e = e058, t = "e058: lateral_disp = 0"),
                 list(e = e059, t = "e059: lateral_disp = 1"),
                 list(e = e060, t = "e060: lateral_disp = 3"))
```
...
```{r}
e067 <- clugen(3, 5, 1500, c(1, 0, 0), pi / 3, c(20, 20, 20), 22, 3, 2, seed = seed)
e068 <- clugen(3, 5, 1500, c(1, 0, 0), pi / 3, c(20, 20, 20), 22, 3, 2, seed = seed,
             proj_dist_fn = "unif")
e069 <- clugen(3, 5, 1500, c(1, 0, 0), pi / 3, c(20, 20, 20), 22, 3, 2, seed = seed,
             proj_dist_fn = proj_beta)
```

```{r}
plot_examples_3d(list(e = e067, t = "e067: proj_dist_fn = 'norm' (default)"),
                 list(e = e068, t = "e068: proj_dist_fn = 'unif'"),
                 list(e = e069, t = "e069: custom proj_dist_fn (Beta dist.)"))
```
...
# Custom clusizes_fn (e078): clusters all have the same size, no correction for
# total points
clusizes_equal <- function(nclu, npts, ae) npts %/% nclu * rep.int(1, nclu)
```

```{r}
e076 <- clugen(3, 4, 1500, c(1, 1, 1), pi, c(20, 20, 20), 0, 0, 5, seed = seed,
              point_dist_fn = "n",
              clucenters_fn = centers_fixed)
e077 <- clugen(3, 4, 1500, c(1, 1, 1), pi, c(20, 20, 20), 0, 0, 5, seed = seed,
              clusizes_fn = clusizes_unif, point_dist_fn = "n",
              clucenters_fn = centers_fixed)
e078 <- clugen(3, 4, 1500, c(1, 1, 1), pi, c(20, 20, 20), 0, 0, 5, seed = seed,
              clusizes_fn = clusizes_equal, point_dist_fn = "n",
              clucenters_fn = centers_fixed)
```

```{r}
plot_examples_3d(list(e = e076, t = "e076: normal dist. (default)"),
                 list(e = e077, t = "e077: unif. dist. (custom)"),
                 list(e = e078, t = "e078: equal size (custom)"))
```
